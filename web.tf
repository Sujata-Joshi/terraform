...
resource "null_resource" "exec" {
  ...
  provisioner "remote-exec" {
    inline = ["curl https://bootstrap.pypa.io/get-pip.py -o get-pip.py", "python3 get-pip.py --user", "export PATH=$PATH:/home/sujata/.local/bin", "python3 -m pip install --user ansible", " python3 -m pip show ansible"]
  }
}